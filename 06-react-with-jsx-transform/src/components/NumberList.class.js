...
// 1. 리액트 클래스 컴포넌트 (재사용)
// 리액트 컴포넌트는 반드시 파스칼케이스(ParcalCase) 유형으로 이름 작성
// 웹 컴포넌트 반드시 케밥케이스 유형으로 이름 작성 (예: <euid-list>)
class NumberList extends React.Component {
  ...
  render() {
    ...
    // 리액트 엘리먼트 반환
    return React.createElement('ul', { id: this.props.id, className: 'architectures', lang: 'en' }, children);
  }
}
...
// const list2 = React.createElement(NumberList, { id: 'list-2', count: 5 });
// const list3 = React.createElement(NumberList, { id: 'list-3', count: 11 });
